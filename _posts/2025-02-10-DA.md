---
layout: post
title: "Data Analyst 분석 방법론"
description: "Data Analyst 핵심 분석 방법론 - 코호트 분석, 퍼널 분석, AARRR, A/B 테스트"
author: "DoorNote"
date: 2025-02-10 10:00:00 +0900
categories: [DA]
tags: [Data Analyst, Python, Cohort Analysis, Funnel Analysis,  AARRR 프레임워크, A/B Test]
comments: true
pin: True # 고정핀
math: true
mermaid: true
...
Acquisition(획득), Activation(활성화), Retention(유지), Revenue(수익), Referral(추천)의<br> 
다섯 가지 핵심 지표로 구성된다.
...
<img src="/assets/img/DA-3.jpeg" style="box-shadow: 4px 4px 15px rgba(0, 0, 0, 0.3); border-radius: 8px;" width="100%">
...
- [Cohort Analysis -1](/posts/2025-02-10-DA-1/) &nbsp;&nbsp; ⬅️ **다음 포스팅** 
- [Funnel Analysis -2](/posts/2025-02-10-DA-2) 
- [AARRR 프레임워크 -3](/posts/2025-02-10-DA-3)
- [A/B Test -4](/posts/2025-02-10-DA-4/)