...
![Airflow-web](/assets/img/Airflow-web.png){: width="900" .center}
_접속_

![Airflow-login](/assets/img/Airflow-login.png){: width="1100" .center}
_로그인_
...
![Airflow-result](/assets/img/Airflow-result.png){: width="1200" .center}
_결과 확인_

- **3. 모델 성능 로그 확인**

![Airflow-models](/assets/img/Airflow-models.png){: width="1200" .center}
_모델 성능 확인_
