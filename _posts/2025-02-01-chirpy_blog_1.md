...
description: "[GitHub Blog] Jekyll Chirpy 테마를 활용한 블로그 설정 방법을 공유합니다."
author: "DoorNote"
...
> 이러한 과정에서 얻은 경험을 바탕으로, **최신 Chirpy 테마**에 맞춤 설정 방법을 체계적으로 정리했습니다.<br>
...
처음 접하시는 분들께는 다소 복잡하게 느껴질 수 있지만, 따라가다 보면 생각보다 금방 익숙해질 거라 믿습니다.<br>

이번 포스트에서 최대한 자세히 설명하려 했지만, 부족한 부분이 있을 수 있습니다.<br>
혹시 잘못된 부분이나 개선할 점이 보인다면 편하게 댓글로 알려주세요.<br>
